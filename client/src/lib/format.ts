...
export function fmtDateTime(iso: string | null | undefined, tz: string = "UTC") {
  if (!iso) return "—";
  try {
...
export function fmtTime(iso: string | null | undefined, tz: string = "UTC") {
  if (!iso) return "—";
  try {
...
export function fmtDate(iso: string | null | undefined, tz: string = "UTC") {
  if (!iso) return "—";
  try {
